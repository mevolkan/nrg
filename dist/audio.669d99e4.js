...
(function() {
    ...
    function eventHandler(e) {
        switch(e.type){
            ...
            case "timeupdate":
                ...
                for(var j1 in audios_status[e.target.id]._progress_markers)if (pct >= j1 && j1 > audios_status[e.target.id].greatest_marker) audios_status[e.target.id].greatest_marker = j1;
    ...
    for(var i = 0; i < audios.length; i++){
        ...
        } else audioTagId = audios[i].getAttribute("id");
...
//# sourceMappingURL=audio.669d99e4.js.map
