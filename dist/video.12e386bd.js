    ...
    function eventHandler(e) {
        switch(e.type){
            ...
            case "timeupdate":
                ...
                for(var j1 in videos_status[e.target.id]._progress_markers)if (pct >= j1 && j1 > videos_status[e.target.id].greatest_marker) videos_status[e.target.id].greatest_marker = j1;
...
//# sourceMappingURL=video.12e386bd.js.map
