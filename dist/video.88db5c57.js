// Variables
if (document.getElementById("audiopage")) window.onload = function() {
    ...
    function renderFrame() {
        ...
        if (!audio.paused) animationFrameId = requestAnimationFrame(renderFrame);
    }
    // Start visualization
    ...
    document.addEventListener("visibilitychange", ()=>{
        if (document.hidden) {
            if (!audio.paused) stopVisualization();
        } else if (!audio.paused) startVisualization();
    });
};
